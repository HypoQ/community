...
public class UserController implements CommunityConstant {
    ...
    @Autowired
    private UploadHeaderService fileUploadService;
    ...
    public String uploadHeader(MultipartFile headerImage, Model model) {
        String[] IMAGE_FILE_EXTD = new String[]{"png", "bmp", "jpg", "jpeg"};
        if (headerImage == null) {
        ...
        String headerUrl = fileUploadService.upload(headerImage,user.getUsername());
    ...
    public String updatePassword(String oldPassword, String newPassword, Model model) {
        User user = hostHolder.getUser();
        Map<String, Object> map = userService.updatePassword(user.getId(), oldPassword,newPassword,newPassword);
